import 'flowbite';
import { HiOutlineBriefcase, HiOutlineHome, HiOutlineUser, HiOutlineSun  } from "react-icons/hi";
    ...
    return (
        <>
            ...
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 shadow-xl" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-slate-950">
                    <div class="my-body">
                        <div class="darkThemeBtn">
                            <input id="darkmode-toggle" type="checkbox" onChange={() => setDarkMode(!darkMode)} checked={darkMode} />
                    ...
                    <a href="#" className="dark:text-slate-50 text-[50px] font-bold text-purple-800">mc<span className="text-purple-500">.</span></a>
                    <ul className="space-y-2 font-medium text-purple-500 dark:text-slate-400 mt-16">
                        <li>
                            <a href="#home" className="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-900 dark:hover:text-purple-500 group">
                                <HiOutlineHome />
                                <span className="ms-3">Início</span>
                            </a>
                        </li>
                        <li>
                            <a href="#about" className="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-900 dark:hover:text-purple-500 group">
                                <HiOutlineUser />
                                <span className="ms-3">Sobre</span>
                            </a>
                        </li>
                        <li>
                            <a href="#experiences" className="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-900 dark:hover:text-purple-500 group">
                                <HiOutlineBriefcase />
